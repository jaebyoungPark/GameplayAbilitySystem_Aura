...
//typedef TBaseStaticDelegateIntance<FGameplayAttribute(), FDefaultDelegateUserPolicy>::FFuncPtr FAttributeFuncPtr;
template<class T>
...
private:
	...
	void ShowFloatingText(const FEffectProperties& Props, float Damage, bool bBlockedHit, bool bCrticialHit) const;
